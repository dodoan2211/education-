...
import { BookOpen, Calendar, MonitorPlay, Presentation, LogOut, Home, Bell, Search, Settings, Shield, Library, ChevronDown, Image, HelpCircle, X, Compass, FileText, Sparkles, Download } from "lucide-react";
              ...
              <div className="space-y-5">
                <div className="flex gap-4 items-start p-3 hover:bg-slate-50 rounded-xl transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600 leading-relaxed">
                      Lựa chọn một trong các tính năng chuyên nghiệp tại menu bên trái: <strong className="text-slate-800">Soạn Giáo Án</strong>, <strong className="text-slate-800">Lập Kế Hoạch</strong>, <strong className="text-slate-800">AI Video</strong>, hoặc <strong className="text-slate-800">Tạo Infographic</strong>.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start p-3 hover:bg-slate-50 rounded-xl transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600 leading-relaxed">
                      Vào <strong className="text-slate-800">Cài đặt tài khoản</strong> để nhập Gemini API Key cá nhân (lấy miễn phí tại Google AI Studio). Sau đó điền chủ đề, yêu cầu bài dạy và tải lên tài liệu tham khảo nếu có.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start p-3 hover:bg-slate-50 rounded-xl transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600 leading-relaxed">
                      Nhấn nút <strong className="text-purple-700">"Chạy luồng xử lý AI"</strong> hoặc <strong className="text-purple-700">"Tạo Infographic"</strong>. Hệ thống AI sẽ lập tức thiết kế nội dung khoa học và tối ưu cấu trúc sư phạm.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start p-3 hover:bg-slate-50 rounded-xl transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600 leading-relaxed">
                      Xem trực quan kết quả và lưu bài giảng vào tài khoản cá nhân hoặc tải về dưới định dạng <strong className="text-emerald-700">Word (DOC)</strong>, <strong className="text-emerald-700">PowerPoint (PPT)</strong>, hay <strong className="text-emerald-700">Infographic</strong>.
                    </p>
                  </div>
                </div>
              </div>
